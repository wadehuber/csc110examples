...
public class Expressions {
	...
	public static void main(String[] args) {
		...
		System.out.println("\tExample 2: \"3\" + \"4\" = " + 3 + 4);       // concatenation
		System.out.println("\tExample 3: 3 + 4 = " + (3 + 4));             // addition
		System.out.println("\tExample 4: 13 / 4 = " + (13 / 4));           // integer division
		System.out.println("\tExample 5: 13 % 4 = " + (13 % 4));           // modulus (remainder)
		System.out.println("\tExample 6: 13 / 4.0 = " + (13 / 4.0));       // division
